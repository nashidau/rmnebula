...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <html>
      <head>
        ...
        <link rel="stylesheet" type="text/css" 
                href="http://www.nash.nu/Rolemaster/XML/rmsscharacter/rmsscharacter.css"
                title="RMSS HTML Character Style" />
      </head>
      <body>
  ...
  <xsl:template match="skill" mode="cat">
    ...
    <xsl:apply-templates select="description" mode="cat" />
  </xsl:template>
  <xsl:template match="description" mode="cat">
     <tr><td colspan="11" class="description"><xsl:value-of select="."/></td></tr>
  </xsl:template>
